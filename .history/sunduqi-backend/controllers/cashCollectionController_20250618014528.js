...
exports.createCollection = async (req, res) => {
  try {
    ...
    if (!delivery) {
      return res.status(404).json({ message: 'سند التسليم غير موجود أو تم استلامه سابقًا' });
    }
    ...
    // ✅ تحديث السند المرتبط بأنه تم استلامه
