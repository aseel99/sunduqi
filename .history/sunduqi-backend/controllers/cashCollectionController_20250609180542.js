...
exports.createCollection = async (req, res) => {
  try {
    ...
    const newCollection = await CashCollection.create({
      collection_number: generateCollectionNumber(), // ✅ هنا الحل
      branch_id,
      collection_date,
      total_collected,
      notes,
      ...
      where: {
        [Op.and]: [
          ...
          Sequelize.literal(`NOT EXISTS (
            ...
            WHERE cc.collected_by = "CashDelivery"."user_id"
              AND cc.branch_id = "CashDelivery"."branch_id"
              AND DATE(cc.collection_date) = '${date}'
          )`)
        ]
      },
      include: [
