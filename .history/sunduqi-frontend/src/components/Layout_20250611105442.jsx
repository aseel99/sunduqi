    ...
    <div className="min-h-screen bg-graylight text-secondary font-arabic">
      <div className="md:flex">
        ...
        <div className="flex-1 md:ml-64 relative">
          {/* رأس الصفحة في الموبايل + زر الإشعارات */}
          <div className="md:hidden p-3 bg-white shadow flex justify-between items-center sticky top-0 z-30">
            ...
            <div className="flex gap-4 items-center">
              <button className="relative">
                <span className="text-xl">🔔</span>
                <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-4 h-4 rounded-full flex items-center justify-center">!</span>
              </button>
