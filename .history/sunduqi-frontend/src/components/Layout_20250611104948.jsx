  ...
  return (
    <div className="min-h-screen bg-graylight text-secondary font-arabic">
      <div className="md:flex">
        {/* الشريط الجانبي */}
        <aside className={`bg-white md:w-64 p-4 shadow-card md:min-h-screen fixed md:static z-30 top-0 right-0 h-full overflow-y-auto ${mobileOpen ? 'block' : 'hidden'} md:block`}>
        ...
        <div className="flex-1 md:ml-64">
          {/* رأس الصفحة في الموبايل */}
          <div className="md:hidden p-3 bg-white shadow flex justify-between items-center sticky top-0 z-20">
