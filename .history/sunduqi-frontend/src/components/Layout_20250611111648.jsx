...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-white text-secondary font-arabic">
      <aside className={`bg-white md:w-64 w-full md:block fixed md:static z-40 top-0 right-0 h-full overflow-y-auto border-l ${mobileOpen ? 'block' : 'hidden'}`}>
        <div className="p-4">
