...
export default function AdminSummary() {
  ...
  return (
    <div className="p-6 text-right">
      ...
      {/* التاريخ + زر عرض الكل */}
      <div className="mb-4 flex justify-end items-center space-x-4 rtl:space-x-reverse">
        ...
        <button
          ...
          className="ml-4 bg-gray-300 hover:bg-gray-400 px-4 py-1 rounded text-sm"
        >
          عرض الكل
        </button>
      </div>
        ...
        <table className="w-full table-auto border border-gray-300">
          ...
          <tfoot>
            <tr className="bg-yellow-100 font-bold text-lg">
              <td className="border p-2 text-center" colSpan={2}>المجموع</td>
              <td className="border p-2">{totalReceipts.toFixed(2)}</td>
              <td className="border p-2">{totalDisbursements.toFixed(2)}</td>
              <td className="border p-2">{totalBalance.toFixed(2)}</td>
              <td className="border p-2">{totalTransferred.toFixed(2)}</td>
              <td className="border p-2 text-red-600">{totalRemaining.toFixed(2)}</td>
