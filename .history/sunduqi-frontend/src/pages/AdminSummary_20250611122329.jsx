          ...
          <table className="min-w-full table-auto text-sm text-right text-gray-800">
                ...
                branchSummaries.map(row => {
                  ...
                  return (
                    <tr key={`${row.branch_id}-${date}`} className="hover:bg-gray-50 border-t">
                      ...
                      <td className="p-2 border">{receipts.toFixed(2)} ₪</td>
                      <td className="p-2 border">{disbursements.toFixed(2)} ₪</td>
                      <td className="p-2 border">{balance.toFixed(2)} ₪</td>
                      <td className="p-2 border">{transferred.toFixed(2)} ₪</td>
                      <td className="p-2 border text-red-600 font-semibold">{remaining.toFixed(2)} ₪</td>
            ...
            <tfoot>
              <tr className="bg-yellow-50 font-bold text-sm">
                ...
                <td className="p-2 border">{totalReceipts.toFixed(2)} ₪</td>
                <td className="p-2 border">{totalDisbursements.toFixed(2)} ₪</td>
                <td className="p-2 border">{totalBalance.toFixed(2)} ₪</td>
                <td className="p-2 border">{totalTransferred.toFixed(2)} ₪</td>
                <td className="p-2 border text-red-600">{totalRemaining.toFixed(2)} ₪</td>
